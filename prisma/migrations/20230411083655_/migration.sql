/*
  ...
  - You are about to drop the column `product_id` on the `Admin_User` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `season_id` on the `Product` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `Admin_User` DROP FOREIGN KEY `Admin_User_product_id_fkey`;
...
-- AlterTable
ALTER TABLE `Admin_User` DROP COLUMN `product_id`,
...
-- AlterTable
ALTER TABLE `Product` DROP COLUMN `season_id`,
